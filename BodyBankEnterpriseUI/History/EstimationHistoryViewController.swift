        ...
        if let request = request{
            ...
            if let result = request.result{
               entries.append(ResultEntry(name: "Neck", value: result.neckCircumference ?? 0, unit: lengthUnit))
                ...
                entries.append(ResultEntry(name: "High Hip", value: result.highHipCircumference ?? 0, unit: lengthUnit))
                ...
                entries.append(ResultEntry(name: "Calf", value: result.calfCircumference ?? 0, unit: lengthUnit))
